...
#Enable Warning BC42105
        ...
        '<Extension>
        '<MethodImpl(MethodImplOptions.AggressiveInlining)>
        'Public Sub StaticCast(Of TSrc As Structure)(value As TSrc, ByRef result As SByte)
        '    ' ldarg.1
        '    ' ldarg.0
        '    ' conv.i1
        '    ' stind.i1
        ...
        '<Extension>
        '<MethodImpl(MethodImplOptions.AggressiveInlining)>
        'Public Sub StaticCast(Of TSrc As Structure)(value As TSrc, ByRef result As Byte)
        '    ' ldarg.1
        '    ' ldarg.0
        '    ' conv.u1
        '    ' stind.i1
        ...
        '<Extension>
        '<MethodImpl(MethodImplOptions.AggressiveInlining)>
        'Public Sub StaticCast(Of TSrc As Structure)(value As TSrc, ByRef result As Short)
        '    ' ldarg.1
        '    ' ldarg.0
        '    ' conv.i2
        '    ' stind.i2
        ...
        '<Extension>
        '<MethodImpl(MethodImplOptions.AggressiveInlining)>
        'Public Sub StaticCast(Of TSrc As Structure)(value As TSrc, ByRef result As UShort)
        '    ' ldarg.1
        '    ' ldarg.0
        '    ' conv.u2
        '    ' stind.i2
        ...
        '<Extension>
        '<MethodImpl(MethodImplOptions.AggressiveInlining)>
        'Public Sub StaticCast(Of TSrc As Structure)(value As TSrc, ByRef result As Integer)
        '    ' ldarg.1
        '    ' ldarg.0
        '    ' conv.i4
        '    ' stind.i4
        ...
        '<Extension>
        '<MethodImpl(MethodImplOptions.AggressiveInlining)>
        'Public Sub StaticCast(Of TSrc As Structure)(value As TSrc, ByRef result As UInteger)
        '    ' ldarg.1
        '    ' ldarg.0
        '    ' conv.u4
        '    ' stind.i4
        ...
        '<Extension>
        '<MethodImpl(MethodImplOptions.AggressiveInlining)>
        'Public Sub StaticCast(Of TSrc As Structure)(value As TSrc, ByRef result As Long)
        '    ' ldarg.1
        '    ' ldarg.0
        '    ' conv.i8
        '    ' stind.i8
        ...
        '<Extension>
        '<MethodImpl(MethodImplOptions.AggressiveInlining)>
        'Public Sub StaticCast(Of TSrc As Structure)(value As TSrc, ByRef result As ULong)
        '    ' ldarg.1
        '    ' ldarg.0
        '    ' conv.u8
        '    ' stind.i8
        ...
        '<Extension>
        '<MethodImpl(MethodImplOptions.AggressiveInlining)>
        'Public Sub StaticCast(Of TSrc)(value As TSrc, ByRef result As IntPtr)
        '    ' ldarg.1
        '    ' ldarg.0
        '    ' conv.i
        '    ' stind.i
        ...
        '<Extension>
        '<MethodImpl(MethodImplOptions.AggressiveInlining)>
        'Public Sub StaticCast(Of TSrc)(value As TSrc, ByRef result As UIntPtr)
        '    ' ldarg.1
        '    ' ldarg.0
        '    ' conv.u
        '    ' stind.i
        ...
        '<Extension>
        '<MethodImpl(MethodImplOptions.AggressiveInlining)>
        'Public Sub StaticCast(Of TSrc As Structure)(value As TSrc, ByRef result As Single)
        '    ' ldarg.1
        '    ' ldarg.0
        '    ' conv.r4
        '    ' stind.r4
        ...
        '<Extension>
        '<MethodImpl(MethodImplOptions.AggressiveInlining)>
        'Public Sub StaticCast(Of TSrc As Structure)(value As TSrc, ByRef result As Double)
        '    ' ldarg.1
        '    ' ldarg.0
        '    ' conv.r8
        '    ' stind.r8
